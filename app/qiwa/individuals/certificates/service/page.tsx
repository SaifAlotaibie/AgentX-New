...
export default function ServiceCertificatePage() {
  ...
  const fetchCertificates = async () => {
    try {
      ...
      if (result.success) {
        const serviceCerts = (result.data || []).filter((cert: Certificate) => cert.certificate_type === 'service_certificate')
        setCertificates(serviceCerts)
      } else {
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#fafafa' }}>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-3xl p-12 mb-8 shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center text-5xl backdrop-blur-sm">
                🎓
              </div>
              <div>
                <h1 className="text-4xl font-bold">شهادة الخدمة</h1>
                <p className="text-white/80 text-lg mt-2">إصدار شهادة خبرة عمل</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <p className="leading-relaxed mb-6" style={{ color: '#4b515a' }}>
              احصل على شهادة خبرة رسمية توضح فترة عملك، المسمى الوظيفي، والمهام التي قمت بها خلال فترة الخدمة.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="border-2 rounded-xl p-6" style={{ borderColor: '#e0e0e0' }}>
                <div className="text-3xl mb-3">📜</div>
                <h3 className="font-bold mb-2" style={{ color: '#20183b' }}>محتوى الشهادة</h3>
                <p style={{ color: '#4b515a' }}>تفاصيل كاملة للخبرة</p>
              </div>
              <div className="border-2 rounded-xl p-6" style={{ borderColor: '#e0e0e0' }}>
                <div className="text-3xl mb-3">🖨️</div>
                <h3 className="font-bold mb-2" style={{ color: '#20183b' }}>التنسيق</h3>
                <p style={{ color: '#4b515a' }}>PDF قابل للطباعة</p>
              </div>
            </div>
